...
\]
para algún $t \in \naturals$. Si $e(G) \geq n^2 / 4$, como $n = 2^{3k}$, se sigue que
\[
...
En general, $e(G)$ no tiene por qué ser $\geq n^2/4$, sin embargo, si se tiene que es $\geq \binom n 2 / 2 = n^2/4 (1-\frac 1 n)$. Una cuenta un poco más complicada nos permite encontrar $t$ tal que se cumple la hipótesis del lema de elección aleatoria dependiente.
\end{proof}
