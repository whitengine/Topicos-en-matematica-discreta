...
\graphicspath{{./Figuras/Teoria extremal de grafos/}{./Figuras/}{./Figuras/Numeros extremales en grafos bipartitos/}{./Figuras/Teoria de Ramsey/}{./Figuras/Metodo-probabilistico-1/}{./Figuras/Conexidad-de-grafos-aleatorios/}} %esto es para que encuentre las figuras hechas con pdf_tex en inkscape
